"""
105_component_prefix_cauchy.py

Component-level prefix/Cesaro drift for the Phase 10 two-component
kernel candidate.
...
Unlike 104_component_block_cauchy.py, this script compares nested
prefix averages:

    j_count N_a -> N_b.

The goal is to test the Cesaro/prefix-average convention after ordinary
adjacent-block drift was found to be non-monotone along the prefix.
"""
...
OUT_REPORT = ROOT / "collatz_105_component_prefix_cauchy_report.md"
OUT_BY_SOURCE = ROOT / "collatz_105_component_prefix_cauchy_by_source.csv"
OUT_BY_ENTRY = ROOT / "collatz_105_component_prefix_cauchy_by_entry.csv"
OUT_BY_PAIR = ROOT / "collatz_105_component_prefix_cauchy_by_pair.csv"
OUT_WORST = ROOT / "collatz_105_component_prefix_cauchy_worst.csv"
...
def output_paths(tag: str | None) -> tuple[Path, Path, Path, Path, Path]:
    ...
    stem = f"collatz_105_{safe}_component_prefix_cauchy"
    return (
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Summarize good/bad component drift between prefix averages.")
...
def main() -> None:
    ...
    print("Component prefix-Cauchy diagnostic written:")
