...
|---|---|---:|---:|---:|---:|---:|---:|
| `all` | `component_l1` | 131064 | 0.0027621063 | 0.009765625 | 0.013183594 | 0.01953125 | 0.045654297 |
| `all` | `label_l1` | 131064 | 0.005743653 | 0.018066406 | 0.024414062 | 0.041259766 | 0.13671875 |
| `all` | `label_excess` | 131064 | 0.0029815467 | 0.010742188 | 0.015625 | 0.03125 | 0.109375 |
| `all` | `retained_row_sum_abs_diff` | 131064 | 0.0020256757 | 0.0073242188 | 0.010253906 | 0.015625 | 0.031738281 |
| `all` | `tail_row_sum_abs_diff` | 131064 | 8.9701734e-06 | 0 | 7.6293945e-05 | 0.00018310547 | 0.00060272217 |
| `good` | `component_l1` | 90104 | 0.0020574316 | 0.0083007812 | 0.01171875 | 0.019042969 | 0.043457031 |
| `good` | `label_l1` | 90104 | 0.0043470384 | 0.016357422 | 0.0234375 | 0.041992188 | 0.13671875 |
| `good` | `label_excess` | 90104 | 0.0022896068 | 0.0078125 | 0.013671875 | 0.03125 | 0.109375 |
| `good` | `retained_row_sum_abs_diff` | 90104 | 0.0014716935 | 0.005859375 | 0.0092773438 | 0.015625 | 0.025634766 |
| `good` | `tail_row_sum_abs_diff` | 90104 | 4.9818751e-06 | 0 | 0 | 0.00012207031 | 0.00054931641 |
| `bad` | `component_l1` | 40960 | 0.004312253 | 0.01171875 | 0.015136719 | 0.021484375 | 0.045654297 |
| `bad` | `label_l1` | 40960 | 0.0088159323 | 0.020507812 | 0.026367188 | 0.040039062 | 0.12109375 |
| `bad` | `label_excess` | 40960 | 0.0045036793 | 0.01171875 | 0.015625 | 0.03125 | 0.1015625 |
| `bad` | `retained_row_sum_abs_diff` | 40960 | 0.0032443285 | 0.0087890625 | 0.01171875 | 0.017333984 | 0.031738281 |
| `bad` | `tail_row_sum_abs_diff` | 40960 | 1.7743651e-05 | 6.1035156e-05 | 0.00012207031 | 0.00024414062 | 0.00060272217 |

## By Prefix Pair

| pair | source | metric | count | mean | p95 | p99 | max |
|---|---|---|---:|---:|---:|---:|---:|
| `64->128` | `all` | `component_l1` | 131064 | 0.0027621063 | 0.013183594 | 0.01953125 | 0.045654297 |
| `64->128` | `all` | `label_l1` | 131064 | 0.005743653 | 0.024414062 | 0.041259766 | 0.13671875 |
| `64->128` | `all` | `label_excess` | 131064 | 0.0029815467 | 0.015625 | 0.03125 | 0.109375 |
| `64->128` | `good` | `component_l1` | 90104 | 0.0020574316 | 0.01171875 | 0.019042969 | 0.043457031 |
| `64->128` | `good` | `label_l1` | 90104 | 0.0043470384 | 0.0234375 | 0.041992188 | 0.13671875 |
| `64->128` | `good` | `label_excess` | 90104 | 0.0022896068 | 0.013671875 | 0.03125 | 0.109375 |
| `64->128` | `bad` | `component_l1` | 40960 | 0.004312253 | 0.015136719 | 0.021484375 | 0.045654297 |
| `64->128` | `bad` | `label_l1` | 40960 | 0.0088159323 | 0.026367188 | 0.040039062 | 0.12109375 |
| `64->128` | `bad` | `label_excess` | 40960 | 0.0045036793 | 0.015625 | 0.03125 | 0.1015625 |
